...
public final class AppConstant {
    ...
    private static final String FILE_MUSIC = Environment.getExternalStorageDirectory().getPath() + "/" + Environment.DIRECTORY_MUSIC;
    private AppConstant() {
    }
    ...
    public static String getKEY_FILE_MUSIC() {
        return FILE_MUSIC;
    }
